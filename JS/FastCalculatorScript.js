...
function validador() {
	if(resposta.value == questoes[aleatorio].resultado) {
        ...
        modal.setContent('<h3>Sua pontuacao foi de ' + pontos + ', mas se quiser melhorar, pode tentar novamente ou passar para a próxima fase.</h3>');
	}
}
...
modal.addFooterBtn('Próxima Fase >', 'tingle-btn tingle-btn--primary tingle-btn--pull-right', function() {
    window.open('MiniGame2/index.html');
});
